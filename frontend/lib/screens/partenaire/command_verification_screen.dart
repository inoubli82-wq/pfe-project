...
class _CommandVerificationScreenState extends State<CommandVerificationScreen> {
  ...
  // ============ HELPER METHOD: BUILD COUNTER ROW ============
  // Creates a reusable counter widget with label, - button, value, + button
  // Parameters:
  //   - title: First part of label (normal weight)
  //   - boldTitle: Second part of label (bold)
  //   - value: Current counter value
  //   - onIncrement: Callback when + is pressed
  //   - onDecrement: Callback when - is pressed
  Widget _buildCounterRow({
    required String title, // required: Must be provided when calling
    required String boldTitle,
    required int value,
    required VoidCallback
        onIncrement, // VoidCallback: Function with no params, returns void
    required VoidCallback onDecrement,
  }) {
    return Row(
      // spaceBetween: Label on left, counter on right
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        // Label with mixed styling
        RichText(
          text: TextSpan(
            style: TextStyle(fontSize: 15, color: Colors.grey[800]),
            children: [
              TextSpan(text: '$title '), // Normal weight
              TextSpan(
                text: boldTitle,
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              // VALUE DISPLAY (center section)
              Container(
                width: 50,
                height: 40,
                decoration: BoxDecoration(
                  // Border.symmetric: Same border on opposite sides
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Colors.blue[700], // Blue to indicate action
                      ),
                    ),
                  ),
                ),
